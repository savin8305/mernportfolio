...
export const updateUser = async (req, res) => {
  try {
    ...
    // Title 1
if(skills.title1){
  user.skills.title1 = skills.title1;
}

// Title 2
if(skills.title2){
  user.skills.title2 = skills.title2;
}

// Title 3
if(skills.title3){
  user.skills.title3 = skills.title3;
}

// Title 4
if(skills.title4){
  user.skills.title4 = skills.title4;
}

// Title 5
if(skills.title5){
  user.skills.title5 = skills.title5;
}

// Title 6
if(skills.title6){
  user.skills.title6 = skills.title6;
}
// Subtitle 1
if(skills.subtitle1){
  user.skills.subtitle1 = skills.subtitle1;
}

// Subtitle 2
if(skills.subtitle2){
  user.skills.subtitle2 = skills.subtitle2;
}

// Subtitle 3
if(skills.subtitle3){
  user.skills.subtitle3 = skills.subtitle3;
}

// Subtitle 4
if(skills.subtitle4){
  user.skills.subtitle4 = skills.subtitle4;
}

// Subtitle 5
if(skills.subtitle5){
  user.skills.subtitle5 = skills.subtitle5;
}

// Subtitle 6
if(skills.subtitle6){
  user.skills.subtitle6 = skills.subtitle6;
}
    ...
    if (about) {
      ...
      if (about.description1) {
        user.about.description1 = about.description1;
      }
      if (about.description2) {
        user.about.description2 = about.description2;
      }
      if (about.description3) {
        user.about.description3 = about.description3;
      }
      if (about.skill1name1) {
        user.about.skill1name1 = about.skill1name1;
      }
      if (about.skill1name2) {
        user.about.skill1name2 = about.skill1name2;
      }
      if (about.skill1name3) {
        user.about.skill1name3 = about.skill1name3;
      }
      if (about.skill1name4) {
        user.about.skill1name4 = about.skill1name4;
      }
      if (about.skill1name5) {
        user.about.skill1name5 = about.skill1name5;
      }
      if (about.skill1name6) {
        user.about.skill1name6 = about.skill1name6;
      }
